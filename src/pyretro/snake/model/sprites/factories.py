...
from pyretro.snake.model.sprites.types import Snake, SnakeFood, TitleSprite
from pyretro.snake.structs import Point, Size

#
# class SnakeCoordinateFactory:
#     def __init__(self, snake_settings: GameSettings):
...
class SnakeCoordinateFactory:
    def __init__(self, unit_size: Size, grid_n: Size):
    ...
    def new_snake_food_location(self) -> Point:
        rand_x = random.randint(0, self.grid_size.width)
        rand_y = random.randint(0, self.grid_size.height)
